...
<?php if (gp_option('gp_toolbar_footer_left') != '') { ?>

    <?php gp_start('div', 'toolbar-left', false); ?>
        
        <?php echo stripslashes(gp_option('gp_toolbar_footer_left')); ?>
...
<?php gp_start('div', 'toolbar-right', false); ?>
    ...
    <?php gp_start('div', 'row', false); ?>
        ...
        <?php if (gp_option('gp_toolbar_footer_socials') != 'false') { ?>

            <?php get_template_part('socials'); ?>

        <?php } ?>

        <?php if (gp_option('gp_toolbar_footer_search') != 'false') { ?>
        ...
        <?php if (gp_option('gp_toolbar_footer_qtranslate') != 'false') { ?>
    ...
    <?php if (gp_option('gp_toolbar_footer_cart') != 'false') { ?>
