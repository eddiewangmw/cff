            ...
            <div class="comment-form grid clearfix">
                ...
                <?php
                    ...
                    $comment_form_args = array(
                        ...
                        'must_log_in'					=> '<p class="must-log-in">' .  sprintf(__('You must be <a href="%s" class="underline">logged in</a> to post a comment.', 'gp'), wp_login_url(apply_filters('the_permalink', get_permalink()))) . '</p>',
                        'logged_in_as'					=> '<p class="logged-in-as">' . sprintf(__('Logged in as <a href="%1$s" class="underline">%2$s</a>. <a href="%3$s" title="Log out of this account" class="underline">Log out?</a>', 'gp'), admin_url('profile.php'), $user_identity, wp_logout_url(apply_filters('the_permalink', get_permalink()))) . '</p>',
