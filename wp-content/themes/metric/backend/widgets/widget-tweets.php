...
class gp_Widget_Tweets extends WP_Widget {
	...
	function gp_Widget_Tweets() {
		...
		$this->WP_Widget('widget_tweets', __('Metric: Tweets', 'gp'), $widget_options, $control_options);
	...
	?>
		...
		<p>
            ...
            <input type="text" class="widefat" id="<?php echo $this->get_field_id('twitter_username'); ?>" name="<?php echo $this->get_field_name('twitter_username'); ?>" type="text" value="<?php echo $twitter_username; ?>" />
        ...
        <p>
            ...
            <input type="text" class="widefat" id="<?php echo $this->get_field_id('twitter_tweets'); ?>" name="<?php echo $this->get_field_name('twitter_tweets'); ?>" type="text" value="<?php echo $twitter_tweets; ?>" />
        ...
        <p>
            ...
            <input type="text" class="widefat" id="<?php echo $this->get_field_id('twitter_button_text'); ?>" name="<?php echo $this->get_field_name('twitter_button_text'); ?>" type="text" value="<?php echo $twitter_button_text; ?>" />
