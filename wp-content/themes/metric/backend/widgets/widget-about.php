...
class gp_Widget_About extends WP_Widget {
	...
	function __construct() {
		...
		$this->WP_Widget('widget_about', __('Metric: About', 'gp'), $widget_options, $control_options);
	...
	function form($instance) {
		...
		?>
            ...
            <p>
                ...
                <textarea class="widefat" rows="12" cols="20" id="<?php echo $this->get_field_id('widget_content'); ?>" name="<?php echo $this->get_field_name('widget_content'); ?>"><?php echo $widget_content; ?></textarea>
                
            </p>
            
            <p>
            	
                <input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id('continue_button'); ?>" name="<?php echo $this->get_field_name('continue_button'); ?>"<?php if ($continue_button) { ?> checked="checked"<?php } ?> />
            ...
            <p>
                ...
                <input type="text" class="widefat" id="<?php echo $this->get_field_id('continue_button_text'); ?>" name="<?php echo $this->get_field_name('continue_button_text'); ?>" value="<?php echo $continue_button_text; ?>" />
            ...
            <p>
                ...
                <input type="text" class="widefat" id="<?php echo $this->get_field_id('continue_button_link'); ?>" name="<?php echo $this->get_field_name('continue_button_link'); ?>" value="<?php echo $continue_button_link; ?>" />
