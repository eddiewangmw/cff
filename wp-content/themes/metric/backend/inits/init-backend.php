...
if (!function_exists('gp_do_settings_fields')) {
	...
	function gp_do_settings_fields($page, $section) {
		...
		foreach ((array) $wp_settings_fields[$page][$section] as $field) {
			...
			if (!empty($field['args']['label_for']) && $field['args']['type'] != 'heading' && $field['args']['type'] != 'subheading') {
			...
			} else if ($field['args']['type'] === 'subheading') {

                if (!empty($field['args']['desc'])) {
                    echo '<tr class="subsection-subheading with-description">';
                } else {
                    echo '<tr class="subsection-subheading">';
                }
